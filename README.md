...
### 🗂️ File Organizer
A Python CLI tool that organizes files in a directory by extension, date, or custom rules. Features include:
- File type categorization
- Date-based organization
- Custom rule support
- Batch processing

**Tech**: Python, Click CLI, pathlib
...
I maintain regular commits to track learning progress. Each project includes:
...
- Master API design and database management
- Implement best practices in code and architecture
- Deploy scalable applications

---

*This repository is a living document of my backend development journey—practical, hands-on, and constantly evolving.*